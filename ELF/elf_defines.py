...
Creation on Fri Feb  2 09:10:07 2024
...
#
# ELF types for a 16-bit quantity.
#
Elf32_Half      = ct.c_uint16
Elf64_Half      = ct.c_uint16

#
# ELF types for signed and unsigned 32-bit quantities.
#
Elf32_Word      = ct.c_uint32
Elf32_Sword     = ct.c_int32
Elf64_Word      = ct.c_uint32
Elf64_Sword     = ct.c_int32

#
# ELF type of addresses.
#
Elf32_Addr      = ct.c_uint32
Elf64_Addr      = ct.c_uint64

#
# ELF type of aoffsets.
#
Elf32_Off       = ct.c_uint32
Elf64_Off       = ct.c_uint64

#
# ELF types for section indices.
#
Elf32_Section   = ct.c_uint16
Elf64_Section   = ct.c_uint16

#
# ELF types for version symbol information.
#
...
EM_8051		    = 165 # Intel 8051 and variants.EM_STXP7X	166	# STMicroelectronics STxP7x.
