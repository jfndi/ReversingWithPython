...
# EXCEPTION macros.
#
STILL_ACTIVE                        = ns.STATUS_PENDING
EXCEPTION_ACCESS_VIOLATION          = ns.STATUS_ACCESS_VIOLATION
EXCEPTION_DATATYPE_MISALIGNMENT     = ns.STATUS_DATATYPE_MISALIGNMENT
EXCEPTION_BREAKPOINT                = ns.STATUS_BREAKPOINT
EXCEPTION_SINGLE_STEP               = ns.STATUS_SINGLE_STEP
EXCEPTION_ARRAY_BOUNDS_EXCEEDED     = ns.STATUS_ARRAY_BOUNDS_EXCEEDED
EXCEPTION_FLT_DENORMAL_OPERAND      = ns.STATUS_FLOAT_DENORMAL_OPERAND
EXCEPTION_FLT_DIVIDE_BY_ZERO        = ns.STATUS_FLOAT_DIVIDE_BY_ZERO
EXCEPTION_FLT_INEXACT_RESULT        = ns.STATUS_FLOAT_INEXACT_RESULT
EXCEPTION_FLT_INVALID_OPERATION     = ns.STATUS_FLOAT_INVALID_OPERATION
EXCEPTION_FLT_OVERFLOW              = ns.STATUS_FLOAT_OVERFLOW
EXCEPTION_FLT_STACK_CHECK           = ns.STATUS_FLOAT_STACK_CHECK
EXCEPTION_FLT_UNDERFLOW             = ns.STATUS_FLOAT_UNDERFLOW
EXCEPTION_INT_DIVIDE_BY_ZERO        = ns.STATUS_INTEGER_DIVIDE_BY_ZERO
EXCEPTION_INT_OVERFLOW              = ns.STATUS_INTEGER_OVERFLOW
EXCEPTION_PRIV_INSTRUCTION          = ns.STATUS_PRIVILEGED_INSTRUCTION
EXCEPTION_IN_PAGE_ERROR             = ns.STATUS_IN_PAGE_ERROR
EXCEPTION_ILLEGAL_INSTRUCTION       = ns.STATUS_ILLEGAL_INSTRUCTION
EXCEPTION_NONCONTINUABLE_EXCEPTION  = ns.STATUS_NONCONTINUABLE_EXCEPTION
EXCEPTION_STACK_OVERFLOW            = ns.STATUS_STACK_OVERFLOW
EXCEPTION_INVALID_DISPOSITION       = ns.STATUS_INVALID_DISPOSITION
EXCEPTION_GUARD_PAGE                = ns.STATUS_GUARD_PAGE_VIOLATION
EXCEPTION_INVALID_HANDLE            = ns.STATUS_INVALID_HANDLE
EXCEPTION_POSSIBLE_DEADLOCK         = ns.STATUS_POSSIBLE_DEADLOCK
CONTROL_C_EXIT                      = ns.STATUS_CONTROL_C_EXIT
